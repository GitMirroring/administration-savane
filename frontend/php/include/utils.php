...
function utils_set_csp_headers ()
{
  ...
  $policy = "Content-Security-Policy: default-src 'none'; style-src 'self' 'unsafe-inline' static.fsf.org; frame-src static.fsf.org; font-src static.fsf.org; script-src static.fsf.org";
