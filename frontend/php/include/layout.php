...
# Copyright (C) 2015-2020, 2022, 2024 Bob Proulx <bob@proulx.com>
...
class Layout extends savane_error
{
  ...
  function header ($params)
  {
    ...
    print "\n<body>\n<div class='realbody'>\n";
    print '<iframe title="FSF Fundraiser Banner"'
      . 'src="//static.gnu.org/nosvn/banners/202411fundraiser/"'
      . 'scrolling="no"'
      . 'style="width: 100%; height: 300px; display: block; '
      . 'margin: 0; border: 0 none; overflow: hidden;">'
      . '</iframe>';
    sitemenu ($params);
